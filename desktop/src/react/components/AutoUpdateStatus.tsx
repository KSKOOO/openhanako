  ...
  if (state.status === 'error') {
    const message = state.error === 'disk_space_insufficient'
      ...
      : state.error === 'running_from_dmg'
        ...
        : state.error === 'linux_manual_update'
          ? t('settings.about.updateManualLinux')
    ...
    return (
      <div className={styles.root}>
        <div className={styles.row}>
          ...
          {state.error && state.error !== 'disk_space_insufficient' && state.error !== 'running_from_dmg' && state.error !== 'linux_manual_update' && (
