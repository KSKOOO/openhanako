...
export function AboutTab() {
  ...
  const updateRequiresExternalInstall = autoUpdate?.status === 'error'
    && (autoUpdate.error === 'running_from_dmg' || autoUpdate.error === 'linux_manual_update');
  ...
  return (
    <div className={`${styles['settings-tab-content']} ${styles['active']}`} data-tab="about">
      ...
      <div className={styles['about-hero']}>
        ...
        />
        {(!autoUpdate || autoUpdate.status === 'idle' || autoUpdate.status === 'latest' || (autoUpdate.status === 'error' && !updateRequiresExternalInstall)) && (
